...
namespace BlendModes
{
    ...
    public abstract class ComponentExtension
    {
        ...
        /// </summary>
        protected ShaderProperty[] ShaderProperties => state != null ? state.ShaderProperties : Array.Empty<ShaderProperty>();
        ...
        public static ComponentExtension CreateForObject (GameObject extendedObject, ComponentExtensionState state)
        {
            ...
            if (!extendedComponent) return null; // No supported component types found on the extended object.
        ...
        {
            return Array.Empty<ShaderProperty>();
        }
