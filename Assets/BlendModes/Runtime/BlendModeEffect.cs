...
namespace BlendModes
{
    ...
    public sealed class BlendModeEffect : MonoBehaviour
    {
        ...
        /// </summary>
        public bool FramebufferEnabled { get => !UrpUtilities.UrpEnabled && framebufferEnabled; set => SetFramebufferEnabled(value); }
        /// <summary>
        /// Whether `Unified Grab` optimization is currently enabled.
        /// Has effect only when <see cref="BlendModes.RenderMode.SelfWithScreen"/> is used.
        /// </summary>
        public bool UnifiedGrabEnabled { get => !UrpUtilities.UrpEnabled && unifiedGrabEnabled; set => SetUnifiedGrabEnabled(value); }
        /// <summary>
        ...
        [SerializeField] private string shaderFamily;
        [SerializeField] private BlendMode blendMode;
        [SerializeField] private RenderMode renderMode;
        [SerializeField] private MaskMode maskMode;
        [SerializeField] private MaskBehaviour maskBehaviour;
        [SerializeField] private Color overlayColor = Color.white;
        [SerializeField] private Texture overlayTexture;
        ...
        [SerializeField] private bool framebufferEnabled;
        [SerializeField] private bool unifiedGrabEnabled;
        [SerializeField] private bool shareMaterial;
        [SerializeField] private Material blendMaterial;
        [SerializeField] private ComponentExtensionState componentExtensionState = new();
        ...
        {
            var blendStencilComp = MaskMode == MaskMode.NothingButMask
                ? (int)CompareFunction.Equal : (int)CompareFunction.NotEqual;
            var normalStencilComp = MaskBehaviour == MaskBehaviour.Cutout
                ? (int)CompareFunction.Never : MaskMode == MaskMode.NothingButMask
                    ? (int)CompareFunction.NotEqual : (int)CompareFunction.Equal;
