...
namespace BlendModes
{
    ...
    public class TMProUGUIExtension : MaskableGraphicExtension<TextMeshProUGUI>
    {
        ...
        {
            get => IsExtendedComponentValid ? GetExtendedComponent<TextMeshProUGUI>().fontMaterial : null;
            set
            {
                if (IsExtendedComponentValid && value) GetExtendedComponent<TextMeshProUGUI>().fontMaterial = value;
            }
        }
