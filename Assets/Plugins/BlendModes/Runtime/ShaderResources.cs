...
namespace BlendModes
{
    ...
    public sealed class ShaderResources : ScriptableObject
    {
        ...
        [SerializeField] private List<Shader> shaders = new();
        ...
        [SerializeField] private List<string> additionalPaths = new();
        ...
        private static readonly Dictionary<string, int> cachedShaderNames = new(StringComparer.Ordinal);
        private static readonly HashSet<string> cachedShaderFamilies = new(StringComparer.Ordinal);
