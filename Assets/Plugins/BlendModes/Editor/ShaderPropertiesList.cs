...
namespace BlendModes
{
    public class ShaderPropertiesList
    {
        ...
        private static readonly GUIContent nameContent = new("Name", "Name of the shader property.");
        private static readonly GUIContent typeContent = new("Type", "Type of the shader property.");
        private static readonly GUIContent valueContent = new("Value", "Value of the shader property.");

        private readonly SerializedObject serializedObject;
        private readonly SerializedProperty serializedProperty;
        private readonly ComponentExtension componentExtension;
        ...
        {
            if (propertiesList?.serializedProperty == null) return false;
            for (int i = 0; i < propertiesList.serializedProperty.arraySize; i++)
                if (ShouldDrawElement(i))
                    return true;
            return false;
        }
    }
